...
public class UIReferenceManager : MonoBehaviour
{
    ...
    public Button turretButton, gaussButton, beamButton, rocketButton, missileButton, teslaButton, dashButton, warpButton, bombButton, dashUnlockButton, warpUnlockButton, bombUnlockButton,soundOffButton,soundOnButton;
    void Awake()
    {
        Instance = this;
    }
